...
$action = $CFG->site;
$ajuda = <<<AJUDA
  <p>O formul&aacute;rio abaixo lista o n&uacute;mero de acessos realizados com cada tipo de navegador.</p>
AJUDA;
...
$nav[]   = 'estatisticas#navegadores.php';
$estilos = false;
...
if ($dados) {
    grafico::exibir_grafico('Gr&aacute;fico de Navegadores Utilizados', $CFG->wwwmods.'estatisticas/grafico_navegadores.php',
                            $CFG->dirmods.'estatisticas/grafico_navegadores.php', $dados);
}
$pagina->fim_conteudo();
$pagina->rodape();
exit(0);
...
//
    ...
    $vet_ordem = array(1 => 'Nome do Navegador', 2 => 'Quantidade de Acessos');
    ...
    $form->campo_bool('versoes', 'versoes', 'Modelos separados por vers&otilde;es', $dados->versoes);
