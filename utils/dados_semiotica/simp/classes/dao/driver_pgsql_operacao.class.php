...
// License: LICENSE.TXT
//
final class driver_pgsql_operacao extends driver_pgsql {
...
/// @ METODOS DE OPERACOES SOBRE O BANCO DE DADOS
    ...
    //
        ...
        $resultado = pg_meta_data($this->conexao, $tabela);
        ...
        if ($resultado) {
            ...
            while ($obj = $this->fetch_object($result3)) {
                if (strpos('nextval', $obj->padrao) !== false) {
                    ...
                    if ($resultado[$obj->atributo]['type'] == 'bool') {
