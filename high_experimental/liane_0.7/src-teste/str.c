...
const char maiusculas[] = "AEIOUÀÁÂÃÉÊÌÍÓÔÕÙÚÜBCDFGHJKLMNPQRSTVWXYZÇÑ";

const char minusculas[] = "aeiouàáâãéêìíóôõùúübcdfghjklmnpqrstvwxyzçñ";

const char digitos[] = "0123456789";

const char alfabeto[] = "AEIOUÀÁÂÃÉÊÌÍÓÔÕÙÚÜaeiouàáâãéêìíóôõùúü"
						"bcdfghjklmnpqrstvwxyzçñBCDFGHJKLMNPQRSTVWXYZÇÑ";

const char delimitadores[] = " ,:;.!?()";

const char vogais[] = "AEIOUÀÁÂÃÉÊÌÍÓÔÕÙÚÜaeiouàáâãéêìíóôõùúü";

const char consoantes[] = "bcdfghjklmnpqrstvwxyzçñBCDFGHJKLMNPQRSTVWXYZÇÑ";

const char acentos[] = "ÀÁÂÃÉÊÌÍÓÔÕÙÚÜàáâãéêìíóôõùúü";

const char incombinantes[] = "bcdfgjkmnpqstvxz";

const char QG[] = "qg";

const char AO[] = "AOaoÁÓáóÂÔâô";

const char EI[] = "EIeiÉÍéí";
