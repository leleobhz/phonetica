...
$action = $CFG->site;
$ajuda  = <<<AJUDA
  <p>O formul&aacute;rio abaixo lista o n&uacute;mero de acessos realizados em um determinado per&iacute;odo. 
...
/// Dados da pagina
$titulo  = 'N&uacute;mero de Acessos';
$nav[]   = '#index.php';
...
if ($dados) {
    grafico::exibir_grafico('Gr&aacute;fico de Acessos', $CFG->wwwmods.$modulo.'/grafico_acessos.php',
                            $CFG->dirmods.$modulo.'/grafico_acessos.php', $dados);
}
$pagina->fim_conteudo();
$pagina->rodape();
exit(0);
