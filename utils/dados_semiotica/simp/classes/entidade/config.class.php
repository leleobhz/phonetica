...
abstract class config_base extends objeto_formulario {
    ...
    protected function definir_atributos() {
        ...
        // CAMPO: cod_config
        $atributo = new atributo('cod_config', 'C&oacute;digo da Configura&ccedil;&atilde;o', null);
        ...
        // CAMPO: ajax
        $atributo = new atributo('ajax', 'Ajax', true);
        ...
        // CAMPO: gd
        $atributo = new atributo('gd', 'GD', true);
        $atributo->set_tipo('bool', false);
        ...
        $atributo = new atributo('autenticacao_http', 'Autentica&ccedil;&atilde;o usando HTTP', false);
        $atributo->set_tipo('bool', false);
        $atributo->set_validacao(false, false, false);
        $this->adicionar_atributo($atributo);
        unset($atributo);
        ...
        // CAMPO: fechado
        $atributo = new atributo('fechado', 'Fechado para Manuten&ccedil;&atilde;o', false);
        $atributo->set_tipo('bool', false);
        $atributo->set_validacao(false, false, false);
        $this->adicionar_atributo($atributo);
        unset($atributo);
        ...
        // CAMPO: autor
        $atributo = new atributo('autor', 'Autor', '');
        $atributo->set_tipo('string', false);
        $atributo->set_intervalo(1, 128);
        $atributo->set_validacao('TEXTO_LINHA', false, false);
        $this->adicionar_atributo($atributo);
        ...
        // CAMPO: link_autor
        $atributo = new atributo('link_autor', 'Link do Autor', '');
        $atributo->set_tipo('string', true);
        $atributo->set_intervalo(1, 255);
        ...
        // CAMPO: preassunto
        $atributo = new atributo('preassunto', 'Prefixo nos Assuntos', '');
        $atributo->set_tipo('string', false);
        ...
        unset($atributo);
         ...
         // CAMPO: email_padrao
        $atributo = new atributo('email_padrao', 'E-mail Padr&atilde;o', '');
        $atributo->set_tipo('string', false);
        $atributo->set_intervalo(1, 128);
        ...
        // CAMPO: cidade
        $atributo = new atributo('cidade', 'Cidade', '');
        $atributo->set_tipo('string', false);
        $atributo->set_intervalo(1, 128);
        $atributo->set_validacao('TEXTO_LINHA', false, false);
        $this->adicionar_atributo($atributo);
        ...
        // CAMPO: estado
        $atributo = new atributo('estado', 'Estado', '--');
        $atributo->set_tipo('string', false);
        ...
        // CAMPO: palavras
        $atributo = new atributo('palavras', 'Palavras', '');
        $atributo->set_tipo('string', false);
